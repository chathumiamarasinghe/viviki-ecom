package com.second.Eccormerce.mapper;

import com.second.Eccormerce.dto.*;
import com.second.Eccormerce.entity.*;
...
public class EntityDtoMapper {
    ...
    public Review mapDtoToReview(ReviewDto dto, Product product, User user) {
