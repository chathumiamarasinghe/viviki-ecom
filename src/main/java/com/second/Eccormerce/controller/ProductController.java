...
import com.second.Eccormerce.service.interf.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<Response> updateProduct(
        ...
        return ResponseEntity.ok(productService.updateProduct(productId, categoryId, image, name, description, price, quantity));
    }
